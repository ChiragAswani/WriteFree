...
def get_credential(cred_db, email):
...
def update_default_setting(cred_db, form_data):
    ...
    draftjs = {"blocks": [{"key": "9043t", "text": " ", "type": "unstyled", "depth": 0,
                           "inlineStyleRanges": [{"offset": 0, "length": 1, "style": "fontsize-" + str(fontSize)},
                                                 {"offset": 0, "length": 1, "style": "fontfamily-" + fontName}],
                           "entityRanges": [], "data": {}}], "entityMap": {}}
    query = {'$set': {'defaultNoteSettings': {'noteColor': noteColor, 'fontName': fontName, 'fontSize': fontSize,
                                              'draftjsObj': draftjs}}}
    dbcalls.DB_find_one_and_update(cred_db, {'_id': _id}, query)
